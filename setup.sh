...
hr
printf "\n"
printf "  ${Y}${BOLD}⚠  Важно:${N} этот проект настраивает роутер, но не предоставляет VPN-сервер.\n"
printf "  Для работы нужен один из вариантов:\n"
printf "    • Платная подписка Amnezia VPN  →  amnezia.org\n"
printf "    • Свой VPS с установленным AmneziaWG (~\$3–5/мес)\n\n"
hr

# ── Предварительные требования ─────────────────────────────────────────
printf "\n${BOLD}Перед началом убедитесь:${N}\n\n"
printf "  1. Есть подписка Amnezia VPN или свой VPS с AmneziaWG\n"
printf "     и скачан файл .conf (в приложении Amnezia: Настройки → Экспорт конфигурации)\n\n"
printf "  2. Роутер прошит на OpenWrt 25.12 и подключён к компьютеру\n"
