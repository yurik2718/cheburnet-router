...
printf "  2. Откройте yandex.ru — должен работать с вашим обычным IP\n"
printf "  3. Откройте youtube.com — должен открываться через VPN\n"
printf "  4. Проверьте ваш IP: https://ifconfig.co\n\n"
