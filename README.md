...
> **⚠️ Сборке нужен AmneziaWG-сервер.** Подробности в шаге 3 ниже.
...
- Бесплатного «всё включено» нет — нужен AmneziaWG-сервер (~300–500 руб/мес)
- Роутер нужно прошить на OpenWrt — это 30 минут по инструкции, один раз
- Это не защита от АНБ и не анонимность — это приватный домашний стенд
