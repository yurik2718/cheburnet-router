...
Этот файл — краткий ориентир для ИИ-моделей (Claude, GPT и т.п.), которые будут помогать дорабатывать конфигурацию в будущем. Люди — читайте [README.md](./README.md).

## Что это за проект

Полная настройка роутера **GL.iNet Beryl AX (GL-MT3000)** на ванильной **OpenWrt 25.12.2** для обхода интернет-цензуры в РФ, с акцентом на:

- Надёжность (должен работать у нетехнических родственников годами без обслуживания)
- Приватность (минимум утечек, доверенные провайдеры)
...
| **gpio_button_hotplug** | Физический слайдер HOME/TRAVEL | [docs/07-hardware.md](docs/07-hardware.md) |
