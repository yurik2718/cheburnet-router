...
> **AI-агентам категорически запрещено делать git commit и git push без явной команды пользователя.**
>
> Вносить изменения в файлы — можно. Коммитить и пушить самостоятельно — нельзя никогда.
> Пользователь сам решает, когда и что сохранять в историю.
